    ...
    <footer className="site-footer">
      <div className="footer-main">
        <div className="footer-brand-newsletter">
          ...
          <p className="footer-subtext">
            Recibe actualizaciones exclusivas sobre nuevos microcontroladores,
            sensores y ofertas directo en tu correo.
          </p>
        ...
        <div className="footer-links-grid">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="/">Componentes Pasivos</a>
              </li>
              <li>
                <a href="/">Microcontroladores</a>
              </li>
              <li>
                <a href="/">Sensores y Módulos</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul>
              <li>
                <a href="#sj">San José Centro</a>
              </li>
              <li>
                <a href="#her">Heredia</a>
              </li>
              <li>
                <a href="#ala">Alajuela</a>
              </li>
              <li>
                <a href="#lim">Limón</a>
              </li>
      ...
      <div className="footer-bottom">
        <div className="footer-copyright">
          &copy; {new Date().getFullYear()} Electro-Commerce CR. Todos los
          derechos reservados.
        </div>
